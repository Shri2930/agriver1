    ...
    <section id="technology" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">CAT-HTR Technology</h2>
...
>
  Your browser does not support the video tag.
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="relative max-w-4xl mx-auto flex flex-col md:flex-row items-center md:h-64 h-auto">
            {/* Step boxes */}
            <div className="flex flex-col md:flex-row w-full justify-between items-center relative z-10 gap-6 md:gap-0">
              <div className="bg-green-100 rounded-lg p-4 text-center w-full md:w-48">
            ...
            {/* Connecting arrows: show only on md+ */}
            <svg className="hidden md:block absolute left-0 top-1/2 w-full h-8 -translate-y-1/2 z-0" height="32">
              {/* Arrow 1 */}
